                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            <!-- Settings Dropdown -->
                            <div class="ms-3 relative space-x-2">
                                <create-post-modal />
                                <kit-dropdown-menu>
                                    <kit-dropdown-trigger>
                                            <kit-button v-if="$page.props.auth.user" variant="ghost" type="button" class="font-medium inline-flex gap-x-2 text-base text-gray-800">
                                                    {{ $page.props.auth.user?.name }}
                                                    <img
                                                        v-if="
                                                            'avatar' in $page.props.auth.user &&
                                                            typeof $page.props.auth.user.avatar === 'string' 
                                                        "
